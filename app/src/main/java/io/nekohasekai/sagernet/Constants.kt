...
object Key {
    ...
    const val TURN_ENABLED = "turnEnabled"
    const val TURN_SERVER = "turnServer"
    const val TURN_PORT = "turnPort"
    const val TURN_PEER = "turnPeer"
    const val TURN_AUTH_LINK = "turnAuthLink"
    const val TURN_SOURCE = "turnSource"
    const val TURN_USE_UDP = "turnUseUdp"
    const val TURN_RELAY_PORT = "turnRelayPort"
