...
class WireGuardSettingsActivity : ProfileSettingsActivity<WireGuardBean>() {
    ...
    private val turnEnabled = pbm.add(PreferenceBinding(Type.Bool, "turnEnabled"))
    private val turnServer = pbm.add(PreferenceBinding(Type.Text, "turnServer"))
    private val turnPort = pbm.add(PreferenceBinding(Type.TextToInt, "turnPort"))
    private val turnPeer = pbm.add(PreferenceBinding(Type.Text, "turnPeer"))
    private val turnAuthLink = pbm.add(PreferenceBinding(Type.Text, "turnAuthLink"))
    private val turnSource = pbm.add(PreferenceBinding(Type.Text, "turnSource"))
    private val turnUseUdp = pbm.add(PreferenceBinding(Type.Bool, "turnUseUdp"))
    private val turnRelayPort = pbm.add(PreferenceBinding(Type.TextToInt, "turnRelayPort"))
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        (turnPort.preference as EditTextPreference).setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        (turnRelayPort.preference as EditTextPreference).setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
    }
