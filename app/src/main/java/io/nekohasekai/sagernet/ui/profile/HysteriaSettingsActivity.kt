...
class HysteriaSettingsActivity : ProfileSettingsActivity<HysteriaBean>() {
    ...
    override fun HysteriaBean.init() {
        ...
        DataStore.turnEnabled = turnEnabled
        DataStore.turnServer = turnServer
        DataStore.turnPort = turnPort
        DataStore.turnPeer = turnPeer
        DataStore.turnAuthLink = turnAuthLink
        DataStore.turnSource = turnSource
        DataStore.turnUseUdp = turnUseUdp
        DataStore.turnRelayPort = turnRelayPort
    }
    ...
    override fun HysteriaBean.serialize() {
        ...
        turnEnabled = DataStore.turnEnabled
        turnServer = DataStore.turnServer
        turnPort = DataStore.turnPort
        turnPeer = DataStore.turnPeer
        turnAuthLink = DataStore.turnAuthLink
        turnSource = DataStore.turnSource
        turnUseUdp = DataStore.turnUseUdp
        turnRelayPort = DataStore.turnRelayPort
    }
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        findPreference<EditTextPreference>(Key.TURN_PORT)!!.apply {
            setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        }
        findPreference<EditTextPreference>(Key.TURN_RELAY_PORT)!!.apply {
            setOnBindEditTextListener(EditTextPreferenceModifiers.Port)
        }
    }
