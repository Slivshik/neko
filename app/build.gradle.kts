...
val buildLibWgGo by tasks.registering(Exec::class) {
    group = "build"
    description = "Build libwg-go.so for all Android ABI and place into app/executableSo."
